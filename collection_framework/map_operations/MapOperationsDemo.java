...
public class MapOperationsDemo {
    public static void main(String[] args) {
        ...
        employeeMap.put(1, new Employee(1, "Uzaif Isani", 50000.0));
        employeeMap.put(2, new Employee(2, "Muskan P", 60000.0));
        employeeMap.put(3, new Employee(3, "Mahek W", 55000.0));
        employeeMap.put(4, new Employee(4, "Nihal W", 65000.0));
        employeeMap.put(5, new Employee(5, "Ammar K", 70000.0));
